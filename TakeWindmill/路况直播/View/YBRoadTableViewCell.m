...
@implementation YBRoadTableViewCell
{
...
//    [_commentView setupWithLikeItemsArray:model.likeItemsArray commentItemsArray:model.commentItemsArray];
    YBLog(@"HeadImgUrl - %@,%ld",imageArray,imageArray.count);
    [_iconView sd_setImageWithURL:[NSURL URLWithString:model.HeadImgUrl]];
    _nameLable.text = model.NickName;
    _contentLabel.text = model.Advice;
