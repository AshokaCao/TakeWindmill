...
@implementation YBProfileCell

+ (instancetype)cellWithTableView:(UITableView *)tableView {
    // 创建cell
    static NSString *ID = @"YBProfileCell";
    YBProfileCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    
    if (cell == nil) {
        cell = [[YBProfileCell alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:ID];
    }
...
- (void)setItem:(YBCommenItem *)item {
    _item = item;
