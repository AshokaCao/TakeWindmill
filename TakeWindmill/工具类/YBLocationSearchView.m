...
#import "YBLocationSearchView.h"
#import "YBTextField.h"

@interface YBLocationSearchView () <UITextFieldDelegate>

@end

@implementation YBLocationSearchView
...
- (void)layoutSubviews {
    ...
    //当前位置
    self.cityButton.frame = CGRectMake(0, 0, 80, 30);
    ...
    if (self.isEnter) {
        //地址输入
        [self.addressText TextFieldFrame:CGRectMake(CGRectGetMaxX(line.frame) + 10, 0, YBWidth - 70 - self.cityButton.frame.size.width, 30) Style:UITextBorderStyleNone placeholder:@"你要去哪儿" Textfont:YBFont(14) textColor:[UIColor blackColor] TextEntry:NO FitWidth:YES cornerRadius:0 borderWidth:0 borderColor:nil];
        ...
        self.addressButton.frame = CGRectMake(CGRectGetMaxX(line.frame) + 10, 0, YBWidth - 70 - self.cityButton.frame.size.width, 30);
