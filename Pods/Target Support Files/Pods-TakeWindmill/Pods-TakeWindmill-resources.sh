...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/DSAlert-OC/DSAlert-OC/DSAlert/DSTableCell.xib"
  ...
  install_resource "${PODS_ROOT}/YQSlideMenController/YQSlideMenuController/YQSlideMenuImages.xcassets"
